...
export const getCalorieTrend = asyncHandler(async (req, res) => {
...
export const getFormTrend = asyncHandler(async (req, res) => {
  const days = Math.min(60, parseInt(req.query.days, 10) || 14);
  const since = daysAgo(days - 1);
...
export const getMuscleHeatmap = asyncHandler(async (req, res) => {
